...
const HackathonPage = () => {
    return (
        <div className="hackathon-container" lang="ru">
            ...
            <h1 className="hackathon-title">II Всероссийский предпринимательский хакатон «Бизнес-кот»-2026 с
            ...
            <section className="hackathon-section">
                <p>
                    ...
                    II Всероссийском предпринимательском хакатоне с международным участием «Бизнес-кот»-2026.
                </p>
